...
export default function SVGs(props: { pathIndex: number }) {
  ...
  return (
    <div className="fixed top-0 pl-0 md:pl-20 left-0 h-screen w-20 sm:w-40 flex justify-center md:items-center items-start">
      <motion.div
        className="border-[0.5px] scale-50 md:scale-125 rounded-full flex items-center justify-center "
        // animate={controls}
      >
        <motion.div
