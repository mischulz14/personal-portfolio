...
export default function Accordion({
  ...
  return (
    <>
      <div
        className={`cursor-pointer sticky top-0 flex justify-between rounded-md px-6 py-4 items-center border-2 border-transparent text-gray-200 bg-opacity-60 ${className}`}
        onClick={() => {
          setOpen((prev) => !prev);
        }}
        style={{
